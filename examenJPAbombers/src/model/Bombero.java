...
public class Bombero implements Serializable {
	...
	public Bombero(int id, String apellidos, String direccion, String dni, Date fechaNacimiento, String nombre,
		String telefono, Parque parque, List<Equipo> equipos) {
	    super();
	    this.id = id;
	    this.apellidos = apellidos;
	    this.direccion = direccion;
